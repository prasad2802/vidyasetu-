...
# Make Gradio happy when mounted at /tutor behind a proxy
...
# ==== Groq model fallback order (edit to taste) ====
GROQ_FALLBACKS = [
    ...
    "groq.compound-mini",
    # keep the line below if you actually have this model in your account;
    # otherwise it will be skipped when 404/422 is returned
    "allam-2-7b",
]
...
default_topic = (
    "Fractions" if "Fractions" in topic_choices
    else (topic_choices[0] if topic_choices else None)
)
...
with gr.Blocks() as demo:
    ...
    with gr.Tab("Practice"):
        if topic_choices:
            ...
            # Should never happen with MCQ_BANK above, but this avoids crashes
